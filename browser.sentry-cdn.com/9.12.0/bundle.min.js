...
var Sentry = function(t) {
    ...
    const a = i("logger", (function() {
        ...
        l = "?",
        d = /\(error: (.*)\)/,
        h = /captureMessage|captureException/;
    ...
    function p(...t) {
        ...
        return (t, e = 0, r = 0) => {
            ...
            for (let t = e; t < i.length; t++) {
                ...
                const s = d.test(e) ? e.replace(d, "$1") : e;
                if (!s.match(/\S*Error: /)) {
                    for (const t of n) {
                        const n = t(s);
                        if (n) {
                    ...
                    if (o.length >= f + r) break
                }
            }
            return function(t) {
                if (!t.length) return [];
                const n = Array.from(t);
                /sentryWrapped/.test(m(n).function || "") && n.pop();
                n.reverse(), h.test(m(n).function || "") && (n.pop(), h.test(m(n).function || "") && n.pop());
                return n.slice(0, f).map((t => ({ ...t,
                    filename: t.filename || m(n).filename,
                    function: t.function || l
                })))
            }(o.slice(r))
        }
    }
    ...
    function x() {
        $ = n.onerror, n.onerror = function(t, n, e, r, o) {
            return S("error", {
                column: r,
                error: o,
                line: e,
    ...
    function I() {
        k = n.onunhandledrejection, n.onunhandledrejection = function(t) {
            return S("unhandledrejection", t), !k || k.apply(this, arguments)
    ...
    function L(t) {
        return null === t || P(t) || "object" != typeof t && "function" != typeof t
    }
    ...
    function F(t) {
        return "undefined" != typeof Event && q(t, Event)
    }
    ...
    function G(t, n = {}) {
        ...
        try {
            ...
            const f = Array.isArray(n) ? n : n.keyAttrs,
                l = !Array.isArray(n) && n.maxStringLength || z;
            for (; e && i++ < r && (a = J(e, f), !("html" === a || i > 1 && s + o.length * u + a.length >= l));) o.push(a), s += a.length, e = e.parentNode;
    ...
    function J(t, n) {
        ...
        const o = n ? .length ? n.filter((t => e.getAttribute(t))).map((t => [t, e.getAttribute(t)])) : null;
    ...
    function V(t, n, e = !1) {
        return !!N(t) && (A(n, "RegExp") ? n.test(t) : !!N(n) && (e ? t === n : t.includes(n)))
    }

    function Z(t, n = [], e = !1) {
        return n.some((n => V(t, n, e)))
    }
    ...
    function nt(t, n) {
        try {
            const e = n.prototype || {};
            t.prototype = n.prototype = e, tt(t, "__sentry_original__", n)
        } catch (t) {}
    }
    ...
    function rt(t) {
        ...
        if (F(t)) {
            ...
            return "undefined" != typeof CustomEvent && q(t, CustomEvent) && (n.detail = t.detail), n
        }
        return t
    }
    ...
    function ot(t) {
        try {
            return n = t, "undefined" != typeof Element && q(n, Element) ? G(t) : Object.prototype.toString.call(t)
        } catch (t) {
            return "<unknown>"
        }
        var n
    ...
    class mt {
        constructor(t) {
            this.o = dt.PENDING, this.i = [], this.u(t)
        }
        then(t, n) {
            return new mt(((e, r) => {
                this.i.push([!1, n => {
        ...
        l() {
            ...
            this.i = [], t.forEach((t => {
                t[0] || (this.o === dt.RESOLVED && t[1](this.h), this.o === dt.REJECTED && t[2](this.h), t[0] = !0)
            }))
        }
        u(t) {
            const n = (t, n) => {
                    this.o === dt.PENDING && (B(n) ? n.then(e, r) : (this.o = t, this.h = n, this.l()))
                },
                e = t => {
                    n(dt.RESOLVED, t)
                },
    ...
    function _t(t, n, e = 2) {
        ...
        for (const t in n) Object.prototype.hasOwnProperty.call(n, t) && (r[t] = _t(r[t], n[t], e - 1));
        return r
    }
    const Et = "_sentrySpan";

    function wt(t, n) {
        n ? tt(t, Et, n) : delete t[Et]
    }
    ...
    class $t {
        constructor() {
            this.p = !1, this.m = [], this.v = [], this._ = [], this.S = [], this.k = {}, this.I = {}, this.j = {}, this.T = {}, this.O = {}, this.R = {
                traceId: vt(),
        ...
        clone() {
            const t = new $t;
            return t._ = [...this._], t.I = { ...this.I
            }, t.j = { ...this.j
            }, t.T = { ...this.T
            }, this.T.flags && (t.T.flags = {
                values: [...this.T.flags.values]
            }), t.k = this.k, t.C = this.C, t.A = this.A, t.D = this.D, t.M = this.M, t.v = [...this.v], t.S = [...this.S], t.O = { ...this.O
            }, t.R = { ...this.R
            }, t.N = this.N, t.P = this.P, wt(t, St(this)), t
        }
        setClient(t) {
            this.N = t
        }
        ...
        setFingerprint(t) {
            return this.M = t, this.L(), this
        }
        setLevel(t) {
            return this.C = t, this.L(), this
        }
        setTransactionName(t) {
            return this.D = t, this.L(), this
        }
        setContext(t, n) {
            return null === n ? delete this.T[t] : this.T[t] = n, this.L(), this
        }
        setSession(t) {
            return t ? this.A = t : delete this.A, this.L(), this
        }
        getSession() {
            return this.A
        }
        update(t) {
            ...
            const n = "function" == typeof t ? t(this) : t,
                e = n instanceof $t ? n.getScopeData() : U(n) ? t : void 0,
                {
                    tags: r,
                    extra: o,
                    user: i,
            ...
            return this.I = { ...this.I,
                ...
                ...s
            }, i && Object.keys(i).length && (this.k = i), c && (this.C = c), u.length && (this.M = u), a && (this.R = a), this
        }
        clear() {
            return this._ = [], this.I = {}, this.j = {}, this.k = {}, this.T = {}, this.C = void 0, this.D = void 0, this.M = void 0, this.A = void 0, wt(this, void 0), this.S = [], this.setPropagationContext({
                traceId: vt(),
                sampleRand: Math.random()
            }), this.L(), this
        }
        addBreadcrumb(t, n) {
            ...
            const r = {
                timestamp: T(),
                ...t,
                message: t.message ? Y(t.message, 2048) : t.message
            };
            return this._.push(r), this._.length > e && (this._ = this._.slice(-e), this.N ? .recordDroppedEvent("buffer_overflow", "log_item")), this.L(), this
        }
        getLastBreadcrumb() {
            return this._[this._.length - 1]
        }
        clearBreadcrumbs() {
            return this._ = [], this.L(), this
        }
        addAttachment(t) {
        ...
        getScopeData() {
            return {
                ...
                level: this.C,
                fingerprint: this.M || [],
                eventProcessors: this.v,
                propagationContext: this.R,
                sdkProcessingMetadata: this.O,
                transactionName: this.D,
                span: St(this)
            }
        }
        setSDKProcessingMetadata(t) {
            return this.O = _t(this.O, t, 2), this
        }
        ...
        captureException(t, n) {
            const e = n ? .event_id || st();
            if (!this.N) return a.warn("No client configured on scope - will not capture exception!"), e;
        ...
        captureMessage(t, n, e) {
            const r = e ? .event_id || st();
            if (!this.N) return a.warn("No client configured on scope - will not capture message!"), r;
            const o = new Error(t);
        ...
        captureEvent(t, n) {
            const e = n ? .event_id || st();
            return this.N ? (this.N.captureEvent(t, { ...n,
                event_id: e
            }, this), e) : (a.warn("No client configured on scope - will not capture event!"), e)
        }
        L() {
            this.p || (this.p = !0, this.m.forEach((t => {
                t(this)
            })), this.p = !1)
        }
    }
    class xt {
        ...
        withScope(t) {
            ...
            return B(e) ? e.then((t => (this.q(), t)), (t => {
                throw this.q(), t
            })) : (this.q(), e)
        }
        getClient() {
        ...
        q() {
            return !(this.U.length <= 1) && !!this.U.pop()
        }
    }

    function kt() {
        const t = o(r());
        return t.stack = t.stack || new xt(i("defaultCurrentScope", (() => new $t)), i("defaultIsolationScope", (() => new $t)))
    }
    ...
    const Pt = "sentry.source",
        Lt = "sentry.sample_rate",
        Ut = "sentry.op",
        Ft = "sentry.origin",
        Bt = "sentry.profile_id",
        qt = "sentry.exclusive_time",
        Ht = 0,
        Wt = 1,
        zt = "_sentryScope",
        Gt = "_sentryIsolationScope";
    ...
    function Zt(t) {
        const n = function(t) {
            if (!t || !N(t) && !Array.isArray(t)) return;
    ...
    const nn = new RegExp("^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$");
    ...
    function en(t, n) {
        ...
        const o = function(t, n) {
            const e = Xt(n ? .sample_rand);
            if (void 0 !== e) return e;
            const r = Xt(n ? .sample_rate);
            return r && void 0 !== t ? .parentSampled ? t.parentSampled ? Math.random() * r : r + Math.random() * (1 - r) : Math.random()
        }(e, r);
    ...
    function sn(t) {
        const {
            ...
            traceId: e,
            isRemote: r
        } = t.spanContext(), o = r ? n : fn(t).parent_span_id, i = Jt(t).scope;
        return {
            parent_span_id: o,
            span_id: r ? i ? .getPropagationContext().propagationSpanId || bt() : n,
            trace_id: e
        }
    }
    ...
    function un(t) {
        return "number" == typeof t ? an(t) : Array.isArray(t) ? t[0] + t[1] / 1e9 : t instanceof Date ? an(t.getTime()) : O()
    }
    ...
    function fn(t) {
        ...
        if (function(t) {
            ...
            return {
                ...
                description: i,
                parent_span_id: c,
                start_timestamp: un(o),
                timestamp: un(s) || void 0,
                status: dn(u),
                op: r[Ut],
                origin: r[Ft],
                links: cn(a)
    ...
    function dn(t) {
        if (t && t.code !== Ht) return t.code === Wt ? "ok" : t.message || "unknown_error"
    }
    const hn = "_sentryRootSpan";
    ...
    function bn(t) {
        ...
        const e = pn(t),
            ...
            s = i ? .get("sentry.sample_rate") ? ? o[Lt];
        ...
        const a = i ? .get("sentry.dsc"),
            f = a && Zt(a);
        if (f) return c(f);
        const l = vn(t.spanContext().traceId, n),
            d = o[Pt],
            h = r.description;
        return "url" !== d && h && (l.transaction = h),
            function(t) {
                if ("boolean" == typeof __SENTRY_TRACING__ && !__SENTRY_TRACING__) return !1;
                const n = t || Mt() ? .getOptions();
                return !(!n || null == n.tracesSampleRate && !n.tracesSampler)
            }() && (l.sampled = String(ln(e)), l.sample_rand = i ? .get("sentry.sample_rand") ? ? Jt(e).scope ? .getPropagationContext().sampleRand.toString()), c(l), n.emit("createDsc", l, e), l
    }
    const _n = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+)?)?@)([\w.-]+)(?::(\d+))?\/(.+)/;
    ...
    function xn(t, n = 3, e = 102400) {
        const r = $n(t, n);
        return o = r,
            function(t) {
                return ~-encodeURI(t).split(/%..|./).length
            }(JSON.stringify(o)) > e ? xn(t, n - 1, e) : r;
        var o
    }

    function kn(t, n, e = 1 / 0, r = 1 / 0, o = function() {
        const t = new WeakSet;
        ...
        const c = function(t, n) {
            try {
                if ("domain" === t && n && "object" == typeof n && n.H) return "[Domain]";
                ...
                if (U(e = n) && "nativeEvent" in e && "preventDefault" in e && "stopPropagation" in e) return "[SyntheticEvent]";
                if ("number" == typeof n && !Number.isFinite(n)) return `[${n}]`;
                if ("function" == typeof n) return `[Function: ${g(n)}]`;
    ...
    function Rn(t) {
        ...
        function o(t) {
            "string" == typeof r ? r = "string" == typeof t ? r + t : [On(r), t] : r.push("string" == typeof t ? On(t) : t)
        }
        for (const t of e) {
            const [n, e] = t;
    ...
    function Cn(t) {
        const n = "string" == typeof t.data ? On(t.data) : t.data;
        return [{
            type: "attachment",
            length: n.length,
            filename: t.filename,
    ...
    function Pn(t, n, e, r = 0) {
        return new mt(((o, i) => {
            ...
            if (null === n || "function" != typeof s) o(n);
                ...
                B(c) ? c.then((n => Pn(t, n, e, r + 1).then(o))).then(null, i) : Pn(t, c, e, r + 1).then(o).then(null, i)
            }
        }))
    }
    let Ln, Un, Fn;
    ...
    function Bn(t, n) {
        ...
        ! function(t, n) {
            ...
            Object.keys(e).length && (t.extra = { ...e,
                ...t.extra
            });
            Object.keys(r).length && (t.tags = { ...r,
                ...t.tags
            });
            Object.keys(o).length && (t.user = { ...o,
                ...t.user
            });
    ...
    function qn(t, n) {
        ...
        Hn(t, "extra", e), Hn(t, "tags", r), Hn(t, "user", o), Hn(t, "contexts", i), t.sdkProcessingMetadata = _t(t.sdkProcessingMetadata, c, 2), s && (t.level = s), h && (t.transactionName = h), p && (t.span = p), u.length && (t.breadcrumbs = [...t.breadcrumbs, ...u]), a.length && (t.fingerprint = [...t.fingerprint, ...a]), f.length && (t.eventProcessors = [...t.eventProcessors, ...f]), l.length && (t.attachments = [...t.attachments, ...l]), t.propagationContext = { ...t.propagationContext,
            ...d
        }
    }
    ...
    function Wn(t, e, r, o, i, s) {
        const {
            normalizeDepth: c = 3,
            normalizeMaxBreadth: u = 1e3
        } = t, a = { ...e,
            event_id: e.event_id || r.event_id || st(),
        ...
        ! function(t, n) {
            ...
            t.environment = t.environment || e || yn, !t.release && r && (t.release = r);
            !t.dist && o && (t.dist = o);
            const s = t.request;
            s ? .url && (s.url = Y(s.url, i))
        }(a, t),
        function(t, n) {
            n.length > 0 && (t.sdk = t.sdk || {}, t.sdk.integrations = [...t.sdk.integrations || [], ...n])
        }(a, f), i && i.emit("applyFrameMetadata", e), void 0 === e.type && function(t, e) {
            const r = function(t) {
                const e = n._sentryDebugIds;
                if (!e) return {};
                const r = Object.keys(e);
                return Fn && r.length === Un || (Un = r.length, Fn = r.reduce(((n, r) => {
                    Ln || (Ln = {});
                    const o = Ln[r];
                    if (o) n[o[0]] = o[1];
                    else {
        ...
        const p = [...r.attachments || [], ...h.attachments];
        p.length && (r.attachments = p), Bn(a, h);
        return Pn([...d, ...h.eventProcessors], a, r).then((t => (t && function(t) {
            const n = {};
            ...
            const r = { ...t,
                ...
                ...t.contexts && {
                    contexts: $n(t.contexts, n, e)
                },
                ...t.extra && {
                    extra: $n(t.extra, n, e)
                }
            };
            t.contexts ? .trace && r.contexts && (r.contexts.trace = t.contexts.trace, t.contexts.trace.data && (r.contexts.trace.data = $n(t.contexts.trace.data, n, e)));
            t.spans && (r.spans = t.spans.map((t => ({ ...t,
                ...t.data && {
                    data: $n(t.data, n, e)
                }
            }))));
            t.contexts ? .flags && r.contexts && (r.contexts.flags = $n(t.contexts.flags, 3, e));
            return r
        }(t, c, u) : t)))
    }
    ...
    function zn(t) {
        if (t) return function(t) {
            ...
            return Object.keys(t).some((t => Gn.includes(t)))
        }(t) ? {
            captureContext: t
        } : t
    }
    const Gn = ["user", "level", "extra", "contexts", "tags", "fingerprint", "propagationContext"];

    function captureException(t, n) {
        return Rt().captureException(t, zn(n))
    }
    ...
    function ne(t, n, e) {
        ...
        return {
            ...
            processEvent(e, r, o) {
                ...
                return function(t, n) {
                    if (t.type) {
                        if ("transaction" === t.type && function(t, n) {
                        ...
                        if (function(t, n) {
                                ...
                                return function(t) {
                                    ...
                                    try {
                                        const e = t.exception.values[t.exception.values.length - 1];
                                        e ? .value && (n.push(e.value), e.type && n.push(`${e.type}: ${e.value}`))
                                    } catch (t) {}
                                    return n
                                }(t).some((t => Z(t, n)))
    ...
    function Ae(t = {}, n = {}) {
        return {
            ...
            ignoreErrors: [...t.ignoreErrors || [], ...n.ignoreErrors || [], ...t.disableErrorDefaults ? [] : Oe],
    ...
    function De(t) {
        try {
            const n = [...t.exception ? .values ? ? []].reverse().find((t => void 0 === t.mechanism ? .parent_id && t.stacktrace ? .frames ? .length)),
    ...
    function Me(t, n, e, r, o, i) {
        if (!o.exception ? .values || !i || !q(i.originalException, Error)) return;
        const s = o.exception.values.length > 0 ? o.exception.values[o.exception.values.length - 1] : void 0;
        s && (o.exception.values = Ne(t, n, r, i.originalException, e, o.exception.values, s, 0))
    }

    function Ne(t, n, e, r, o, i, s, c) {
        ...
        if (q(r[o], Error)) {
            ...
            const i = t(n, r[o]),
                a = u.length;
            Le(i, o, a, c), u = Ne(t, n, e, r[o], o, [i, ...u], i, a)
        }
        return Array.isArray(r.errors) && r.errors.forEach(((r, i) => {
            if (q(r, Error)) {
                ...
                const a = t(n, r),
                    f = u.length;
                Le(a, `errors[${i}]`, f, c), u = Ne(t, n, e, r, o, [a, ...u], a, f)
            }
        })), u
    }
    ...
    function Ue() {
        "console" in n && s.forEach((function(t) {
            t in n.console && Q(n.console, t, (function(e) {
                return c[t] = e,
                    function(...e) {
                        S("console", {
                            args: e,
    ...
    function Ye() {
        ...
        if (Xe(Je.fetch)) return !0;
        let t = !1;
        const n = Je.document;
        if (n && "function" == typeof n.createElement) try {
            const e = n.createElement("iframe");
            e.hidden = !0, n.head.appendChild(e), e.contentWindow ? .fetch && (t = Xe(e.contentWindow.fetch)), n.head.removeChild(e)
        } catch (t) {}
        return t
    }
    ...
    function Ke(t, e) {
        const r = "fetch";
        E(r, t), w(r, (() => function(t, e = !1) {
            if (e && !Ye()) return;
            Q(n, "fetch", (function(t) {
                return function(...e) {
                    const r = new Error,
                        {
                            method: o,
                            ...
                            return {
                                url: Ze(n),
                                method: Ve(n, "method") ? String(n.method).toUpperCase() : "GET"
                            }
                        }(e),
                        s = {
                            args: e,
                            ...
                            startTimestamp: 1e3 * O(),
                            virtualError: r,
                            headers: Qe(e)
                        };
                    return S("fetch", { ...s
                    }), t.apply(n, e).then((async t => (S("fetch", { ...s,
                        endTimestamp: 1e3 * O(),
                        response: t
                    }), t)), (t => {
                        if (S("fetch", { ...s,
                                endTimestamp: 1e3 * O(),
                                error: t
                            }), C(t) && void 0 === t.stack && (t.stack = r.stack, tt(t, "framesToPop", 1)), t instanceof TypeError && ("Failed to fetch" === t.message || "Load failed" === t.message || "NetworkError when attempting to fetch resource." === t.message)) try {
                            const n = new URL(s.fetchData.url);
                            t.message = `${t.message} (${n.host})`
                        } catch {}
                        throw t
                    }))
                }
    ...
    function Ze(t) {
        return "string" == typeof t ? t : t ? Ve(t, "url") ? t.url : t.toString ? t.toString() : "" : ""
    }

    function Qe(t) {
        const [n, e] = t;
        try {
            if ("object" == typeof e && null !== e && "headers" in e && e.headers) return new Headers(e.headers);
            if (r = n, "undefined" != typeof Request && q(r, Request)) return new Headers(n.headers)
        } catch {}
        var r
    }
    const tr = () => {},
        nr = ["attachTo", "createForm", "createWidget", "remove"],
        er = Object.assign((t => (u((() => {
            console.warn("You are using feedbackIntegration() even though this bundle does not include feedback.")
        })), {
            name: "Feedback",
            ...nr.reduce(((t, n) => (t[n] = tr, t)), {})
        })), {
            _isShim: !0
        }),
        rr = ["start", "stop", "flush"];
    ...
    function ur(t, n = {}) {
        ...
        const sentryWrapped = function(...e) {
            try {
                ...
                throw sr++, setTimeout((() => {
                    ...
                    r.addEventProcessor((t => (n.mechanism && (at(t, void 0), ft(t, n.mechanism)), t.extra = { ...t.extra,
                        arguments: e
        ...
        nt(sentryWrapped, t), tt(t, "__sentry_wrapped__", sentryWrapped);
        try {
    ...
    function fr(t, n, e, r) {
        ...
        const u = {
            exception: {
                values: [{
                    type: F(n) ? n.constructor.name : r ? "UnhandledRejection" : "Error",
                    value: Er(n, {
    ...
    function dr(t, n) {
        const e = n.stacktrace || n.stack || "",
            r = function(t) {
                if (t && hr.test(t.message)) return 1;
                return 0
            }(n),
            o = function(t) {
    ...
    const hr = /Minified React error #\d+;/i;
    ...
    function yr(t) {
        const n = t ? .message;
        return pr(t) ? Array.isArray(t.message) && 2 == t.message.length ? t.message[1] : "wasm exception" : n ? n.error && "string" == typeof n.error.message ? n.error.message : n : "No error message"
    }

    function gr(t, n, e, r) {
        const o = br(t, n, e ? .syntheticException || void 0, r);
        return ft(o), o.level = "error", e ? .event_id && (o.event_id = e.event_id), ht(o)
    }

    function vr(t, n, e = "info", r, o) {
        const i = _r(t, n, r ? .syntheticException || void 0, o);
        return i.level = e, r ? .event_id && (i.event_id = r.event_id), ht(i)
    }
    ...
    function br(t, n, e, r, o) {
        ...
        if (M(n) || A(n, "DOMException")) {
            const o = n;
            if ("stack" in n) i = lr(t, n);
            else {
                const n = o.name || (M(o) ? "DOMError" : "DOMException"),
        ...
        if (C(n)) return lr(t, n);
        if (U(n) || F(n)) {
            return i = fr(t, n, e, o), ft(i, {
                synthetic: !0
            }), i
        }
        return i = _r(t, n, e, r), at(i, `${n}`), ft(i, {
            synthetic: !0
        }), i
    }
    ...
    function Er(t, {
        ...
        const e = function(t, n = 40) {
                const e = Object.keys(rt(t));
                e.sort();
                const r = e[0];
                if (!r) return "[object has no keys]";
                if (r.length >= n) return Y(r, n);
                for (let t = e.length; t > 0; t--) {
                    const r = e.slice(0, t).join(", ");
                    if (!(r.length > n)) return t === e.length ? r : Y(r, n)
                }
                return ""
            }(t),
            r = n ? "promise rejection" : "exception";
        if (D(t)) return `Event \`ErrorEvent\` captured as ${r} with message \`${t.message}\``;
        if (F(t)) {
            return `Event \`${function(t){try{const n=Object.getPrototypeOf(t);return n?n.constructor.name:void 0}catch(t){}}(t)}\` (type=${t.type}) captured as ${r}`
        }
    ...
    class wr extends fe {
        constructor(t) {
            ...
            }(n, "browser", ["browser"], ir.SENTRY_SDK_SOURCE || "cdn"), super(n);
            const r = this,
                {
                    sendDefaultPii: o,
                    _experiments: i
                ...
                s = i ? .enableLogs;
            n.sendClientReports && ir.document && ir.document.addEventListener("visibilitychange", (() => {
                "hidden" === ir.document.visibilityState && (this.ct(), s && me(r))
            })), s && (r.on("flush", (() => {
                me(r)
            })), r.on("afterCaptureLog", (() => {
                r.ut && clearTimeout(r.ut), r.ut = setTimeout((() => {
                    me(r)
                }), 5e3)
            }))), o && (r.on("postprocessEvent", Se), r.on("beforeSendSession", $e))
        }
        eventFromException(t, n) {
            return gr(this.W.stackParser, t, n, this.W.attachStacktrace)
        }
        eventFromMessage(t, n = "info", e) {
            return vr(this.W.stackParser, t, n, e, this.W.attachStacktrace)
        }
        ot(t, n, e, r) {
            return t.platform = t.platform || "javascript", super.ot(t, n, e, r)
        }
    }
    const Sr = n,
        $r = 1e3;
    ...
    function Tr() {
        if (!Sr.document) return;
        const t = S.bind(null, "dom"),
            n = Or(t, !0);
        Sr.document.addEventListener("click", n, !1), Sr.document.addEventListener("keypress", n, !1), ["EventTarget", "Node"].forEach((n => {
            const e = Sr,
                r = e[n] ? .prototype;
            r ? .hasOwnProperty ? .("addEventListener") && (Q(r, "addEventListener", (function(n) {
    ...
    function Or(t, n = !1) {
        return e => {
            ...
            if (function(t, n) {
                    return "keypress" === t && (!n ? .tagName || "INPUT" !== n.tagName && "TEXTAREA" !== n.tagName && !n.isContentEditable)
                }(e.type, r)) return;
            tt(e, "_sentryCaptured", !0), r && !r._sentryId && tt(r, "_sentryId", st());
            const o = "keypress" === e.type ? "input" : e.type;
            if (! function(t) {
                    if (t.type !== kr) return !1;
                    try {
                ...
                t({
                    ...
                    name: o,
                    global: n
                }), kr = e.type, Ir = r ? r._sentryId : void 0
            }
            clearTimeout(xr), xr = Sr.setTimeout((() => {
                Ir = void 0, kr = void 0
            }), $r)
        }
    }
    ...
    function Cr() {
        function t(t) {
            return function(...n) {
                ...
                if (e) {
                    const r = jr,
                        o = String(e);
                    if (jr = o, r === o) return t.apply(this, n);
                    S("history", {
                        from: r,
                        to: o
                    })
        ...
        Sr.addEventListener("popstate", (() => {
            const t = Sr.location.href,
                n = jr;
            if (jr = t, n === t) return;
            S("history", {
                from: n,
        ...
        })), "history" in Je && Je.history && (Q(Sr.history, "pushState", t), Q(Sr.history, "replaceState", t))
    }
    const Ar = {};
    ...
    function Nr() {
        if (!Sr.XMLHttpRequest) return;
        const t = XMLHttpRequest.prototype;
        t.open = new Proxy(t.open, {
            apply(t, n, e) {
                const r = new Error,
                    o = 1e3 * O(),
                    i = N(e[0]) ? e[0].toUpperCase() : void 0,
                    s = function(t) {
                        if (N(t)) return t;
                        try {
                            return t.toString()
                ...
                return "onreadystatechange" in n && "function" == typeof n.onreadystatechange ? n.onreadystatechange = new Proxy(n.onreadystatechange, {
                    ...
                    apply(t, n, e) {
                        const [r, o] = e, i = n[Mr];
                        return i && N(r) && N(o) && (i.request_headers[r.toLowerCase()] = o), t.apply(n, e)
                    }
                }), t.apply(n, e)
            }
    ...
    function Pr(t, n = function(t) {
        const n = Ar[t];
        if (n) return n;
        let e = Sr[t];
        if (Xe(e)) return Ar[t] = e.bind(Sr);
        const r = Sr.document;
        ...
        return we(t, (function(o) {
            ...
            if (!n) return Dr("fetch"), pt("No fetch implementation available");
            try {
    ...
    function Lr(t, n, e, r) {
        const o = {
            filename: t,
            function: "<anonymous>" === n ? l : n,
            in_app: !0
        };
        return void 0 !== e && (o.lineno = e), void 0 !== r && (o.colno = r), o
    }
    const Ur = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
        Fr = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        Br = /\((\S*)(?::(\d+))(?::(\d+))\)/,
        qr = [30, t => {
            const n = Ur.exec(t);
            if (n) {
            ...
            if (e) {
                ...
                const [t, n] = to(e[1] || l, e[2]);
                return Lr(n, t, e[3] ? +e[3] : void 0, e[4] ? +e[4] : void 0)
            }
        }],
        Hr = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
        ...
        zr = [50, t => {
            ...
            if (n) {
                ...
                let t = n[3],
                    e = n[1] || l;
                return [e, t] = to(e, t), Lr(t, e, n[4] ? +n[4] : void 0, n[5] ? +n[5] : void 0)
            }
        }],
        Gr = /^\s*at (?:((?:\[object object\])?.+) )?\(?((?:[-a-z]+):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
        Jr = [40, t => {
            const n = Gr.exec(t);
            return n ? Lr(n[2], n[1] || l, +n[3], n[4] ? +n[4] : void 0) : void 0
        }],
        Xr = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i,
        Yr = [10, t => {
            const n = Xr.exec(t);
            return n ? Lr(n[2], n[3] || l, +n[1]) : void 0
        }],
        Kr = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^)]+))\(.*\))? in (.*):\s*$/i,
        Vr = [20, t => {
            const n = Kr.exec(t);
            return n ? Lr(n[5], n[3] || n[4] || l, +n[1], +n[2]) : void 0
        }],
        Zr = [qr, zr],
        Qr = p(...Zr),
        to = (t, n) => {
            ...
            return e || r ? [-1 !== t.indexOf("@") ? t.split("@")[0] : l, e ? `safari-extension:${n}` : `safari-web-extension:${n}`] : [t, n]
        };
    const no = 1024,
        eo = (t = {}) => {
            const n = {
            ...
            return {
                ...
                setup(t) {
                    ...
                    n.console && function(t) {
                        ...
                        return function(n) {
                            ...
                            if ("assert" === n.level) {
                                ...
                                e.message = `Assertion failed: ${K(n.args.slice(1)," ")||"console.assert"}`, e.data.arguments = n.args.slice(1)
                            }
                            ke(e, {
                                input: n.args,
                                level: n.level
                        ...
                        return function(e) {
                            ...
                            s && s > no && (s = no), "string" == typeof i && (i = [i]);
                            try {
                                const t = e.event,
                                    n = function(t) {
                                        return !!t && !!t.target
                    ...
                    }(t, n.dom), E("dom", e), w("dom", Tr)), n.xhr && function(t) {
                        E("xhr", t), w("xhr", Nr)
                    }(function(t) {
                        return function(n) {
                            if (Mt() !== t) return;
                            ...
                            t.emit("beforeOutgoingRequestBreadcrumb", l, f), ke(l, f)
                        }
                    }(t)), n.fetch && Ke(function(t) {
                        return function(n) {
                            if (Mt() !== t) return;
                            const {
                                startTimestamp: e,
                            ...
                            if (r && (!n.fetchData.url.match(/sentry_key/) || "POST" !== n.fetchData.method))
                                if (n.error) {
                                    ...
                                    t.emit("beforeOutgoingRequestBreadcrumb", s, i), ke(s, i)
                                } else {
                                    const o = n.response,
                                        i = { ...n.fetchData,
                                        ...
                                        c = {
                                            ...
                                            data: i,
                                            type: "http",
                                            level: Ge(i.status_code)
                                        };
                                    t.emit("beforeOutgoingRequestBreadcrumb", c, s), ke(c, s)
                                }
                        }
                    }(t)), n.history && Rr(function(t) {
                        return function(n) {
                            if (Mt() !== t) return;
                            let e = n.from,
                                r = n.to;
                            const o = ze(ir.location.href);
                            let i = e ? ze(e) : void 0;
                            const s = ze(r);
                            i ? .path || (i = o), o.protocol === s.protocol && o.host === s.host && (r = s.relative), o.protocol === i.protocol && o.host === i.host && (e = i.relative), ke({
                                category: "navigation",
                                data: {
                                    from: e,
                                    to: r
    ...
    const ro = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "BroadcastChannel", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "SharedWorker", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
        oo = (t = {}) => {
            ...
            return {
                ...
                setupOnce() {
                    n.setTimeout && Q(ir, "setTimeout", io), n.setInterval && Q(ir, "setInterval", io), n.requestAnimationFrame && Q(ir, "requestAnimationFrame", so), n.XMLHttpRequest && "XMLHttpRequest" in ir && Q(XMLHttpRequest.prototype, "send", co);
                    const t = n.eventTarget;
                    if (t) {
                        (Array.isArray(t) ? t : ro).forEach(uo)
                    }
                }
            }
        };
            ...
            return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((t => {
                t in e && "function" == typeof e[t] && Q(e, t, (function(n) {
                    const e = {
                        ...
                        r = et(n);
                    return r && (e.mechanism.data.handler = g(r)), ur(n, e)
                }))
            })), t.apply(this, n)
        }
    }
    ...
    function uo(t) {
        const n = ir,
            e = n[t] ? .prototype;
        e ? .hasOwnProperty ? .("addEventListener") && (Q(e, "addEventListener", (function(n) {
            return function(e, r, o) {
                try {
                    "function" == typeof r.handleEvent && (r.handleEvent = ur(r.handleEvent, {
                        mechanism: {
                            data: {
        ...
        })), Q(e, "removeEventListener", (function(t) {
            return function(n, e, r) {
                try {
    ...
    const ho = () => ({
            name: "HttpContext",
            preprocessEvent(t) {
                if (!ir.navigator && !ir.location && !ir.document) return;
                const n = t.request ? .url || X(),
                    {
                        referrer: e
                    } = ir.document || {},
                    {
        ...
        po = (t = {}) => {
            ...
            return {
                ...
                preprocessEvent(t, r, o) {
                    Me(ar, o.getOptions().stackParser, e, n, t, r)
                }
            }
        };

    function mo(t) {
        return [Ce(), Te(), oo(), eo(), fo(), po(), Be(), ho(), ao()]
    }
    ...
    const go = {
        ...
        vo = ir;
    return t.BrowserClient = wr, t.SDK_VERSION = e, t.SEMANTIC_ATTRIBUTE_SENTRY_OP = Ut, t.SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN = Ft, t.SEMANTIC_ATTRIBUTE_SENTRY_SAMPLE_RATE = Lt, t.SEMANTIC_ATTRIBUTE_SENTRY_SOURCE = Pt, t.Scope = $t, t.WINDOW = ir, t.addBreadcrumb = ke, t.addEventProcessor = function(t) {
        Ct().addEventProcessor(t)
    }, t.addIntegration = function(t) {
        const n = Mt();
        n && n.addIntegration(t)
    }, t.breadcrumbsIntegration = eo, t.browserApiErrorsIntegration = oo, t.browserTracingIntegration = or, t.captureEvent = Jn, t.captureException = captureException, t.captureFeedback = function(t, n = {}, e = Rt()) {
        const {
            message: r,
            name: o,
            email: i,
    ...
    }, t.captureSession = Zn, t.chromeStackLineParser = qr, t.close = async function(t) {
        const n = Mt();
    ...
    }, t.createTransport = we, t.createUserFeedbackEnvelope = function(t, {
        metadata: n,
        tunnel: e,
        dsn: r
    }) {
        ...
        return In(o, [i])
    }, t.dedupeIntegration = Be, t.defaultStackLineParsers = Zr, t.defaultStackParser = Qr, t.endSession = Kn, t.eventFiltersIntegration = Re, t.eventFromException = gr, t.eventFromMessage = vr, t.exceptionFromError = ar, t.feedbackAsyncIntegration = er, t.feedbackIntegration = er, t.flush = async function(t) {
        const n = Mt();
        return n ? n.flush(t) : Promise.resolve(!1)
    }, t.forceLoad = function() {}, t.functionToStringIntegration = Te, t.geckoStackLineParser = zr, t.getClient = Mt, t.getCurrentScope = Rt, t.getDefaultIntegrations = mo, t.getGlobalScope = At, t.getIsolationScope = Ct, t.globalHandlersIntegration = fo, t.httpContextIntegration = ho, t.inboundFiltersIntegration = Ce, t.init = function(t = {}) {
        const n = function(t = {}) {
            return {
                defaultIntegrations: mo(),
                release: "string" == typeof __SENTRY_RELEASE__ ? __SENTRY_RELEASE__ : ir.SENTRY_RELEASE ? .id,
                sendClientReports: !0,
                ...yo(t)
            }
        }(t);
        if (!n.skipBrowserExtensionCheck && function() {
                const t = void 0 !== ir.window && ir;
                if (!t) return !1;
                const n = t[t.chrome ? "chrome" : "browser"],
                    e = n ? .runtime ? .id,
                    r = X() || "",
                    o = !!e && ir === ir.top && ["chrome-extension:", "moz-extension:", "ms-browser-extension:", "safari-web-extension:"].some((t => r.startsWith(`${t}//`))),
                    i = void 0 !== t.nw;
                return !!e && !o && !i
            }()) return;
        const e = { ...n,
            stackParser: (r = n.stackParser || Qr, Array.isArray(r) ? p(...r) : r),
            integrations: re(n),
            transport: n.transport || Pr
        };
        var r;
        return function(t, n) {
            !0 === n.debug && u((() => {
            ...
            const e = new t(n);
            return ye(e), e.init(), e
        }(wr, e)
    }, t.isInitialized = function() {
        return !!Mt()
    }, t.lastEventId = Xn, t.lazyLoadIntegration = async function(t, n) {
        const r = go[t],
            o = vo.Sentry = vo.Sentry || {};
        ...
        const s = function(t) {
            ...
            c = ir.document.createElement("script");
        c.src = s, c.crossOrigin = "anonymous", c.referrerPolicy = "strict-origin", n && c.setAttribute("nonce", n);
        const u = new Promise(((t, n) => {
                c.addEventListener("load", (() => t())), c.addEventListener("error", n)
            })),
            a = ir.document.currentScript,
            f = ir.document.body || ir.document.head || a ? .parentElement;
        ...
        return l
    }, t.linkedErrorsIntegration = po, t.makeFetchTransport = Pr, t.onLoad = function(t) {
        t()
    }, t.opera10StackLineParser = Yr, t.opera11StackLineParser = Vr, t.parameterize = function(t, ...n) {
        ...
        return u((() => {
            ...
            name: "Replay",
            ...rr.reduce(((t, n) => (t[n] = tr, t)), {})
        }
    }, t.setContext = function(t, n) {
        Ct().setContext(t, n)
    }, t.setCurrentClient = ye, t.setExtra = function(t, n) {
        Ct().setExtra(t, n)
        ...
        const n = Rt(),
            ...
            r = e ? .getDsn();
        if (!r) return;
        if (n && (t.user = { ...n.getUser(),
                ...t.user
            }), !t.eventId) {
            const n = Xn();
            n && (t.eventId = n)
        }
        const o = ir.document.createElement("script");
        o.async = !0, o.crossOrigin = "anonymous", o.src = function(t, n) {
            const e = Sn(t);
            if (!e) return "";
            const r = `${te(e)}embed/error-page/`;
            let o = `dsn=${En(e)}`;
            for (const t in n)
                if ("dsn" !== t && "onClose" !== t)
                    if ("user" === t) {
        ...
        if (i) {
            const t = n => {
                if ("__sentry_reportdialog_closed__" === n.data) try {
                    ...
                    ir.removeEventListener("message", t)
                }
            };
            ir.addEventListener("message", t)
        }
        const s = ir.document.head || ir.document.body;
        s && s.appendChild(o)
    }, t.spanToBaggageHeader = function(t) {
        return Qt(bn(t))
    }, t.spanToJSON = fn, t.spanToTraceHeader = function(t) {
        const {
            traceId: n,
            spanId: e
        } = t.spanContext();
        return function(t = vt(), n = bt(), e) {
            let r = "";
            return void 0 !== e && (r = e ? "-1" : "-0"), `${t}-${n}${r}`
        }(n, e, ln(t))
    }, t.startSession = Yn, t.suppressTracing = function(t) {
        const n = Ot(r());
        return n.suppressTracing ? n.suppressTracing(t) : Dt((n => (n.setSDKProcessingMetadata({
            __SENTRY_SUPPRESS_TRACING__: !0
        }), t())))
    }, t.updateSpanName = function(t, n) {
        t.updateName(n), t.setAttributes({
            [Pt]: "custom",
            "sentry.custom_span_name": n
        })
    }, t.winjsStackLineParser = Jr, t.withIsolationScope = function(...t) {
        const n = Ot(r());
        if (2 === t.length) {
            const [e, r] = t;
